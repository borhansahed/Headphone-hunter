...
const CustomerReview = () => {
    ...
    return (
        ...
        <button  className=' mt-8 p-3 bg-gray-300 font-normal rounded-md hover:shadow-lg hover:bg-gray-500 button-container' ><Link to="/review">See All Reviews</Link></button>
       </div>
    </div>
    );
};
